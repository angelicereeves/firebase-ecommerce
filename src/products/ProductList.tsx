...
// Local product type for this page; align fields with Firestore schema.
type Product = {
  id: string;
  title: string;
  description?: string;
  ...
  imageUrl?: string;
  category?: string;
  createdAt?: Timestamp; // Firestore timestamp for ordering/formatting
};
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Keep id + data; narrow to Product (data() has no id field)
